...
<head>
    ...
    <title>AaarogyaHomeCare Dashboard</title>
    <!-- plugins:css -->
    ...
    <link rel="stylesheet" href="../dashboard/assets/vendors/iconfonts/font-awesome/css/font-awesome.css">
...
<div class="container-scroller">
    ...
    <?php require '../dashboard/partials/_navbar.php' ?>
    <!-- partial -->
    <div class="container-fluid page-body-wrapper">
        <?php require '../dashboard/partials/_sidebar.php' ?>
        <!-- partial -->
